...
/**
 * Fragment which displays the list of installed apps through a ViewPager.
 *
...
public class AppDrawerFragment extends Fragment {
    ...
    private OnAppFavoritedListener onAppFavorited = new OnAppFavoritedListener() {
        ...
        public void onAppFavorited(AppTransferInfo favoriteInfo) {
            ...
            FavoritePageFragment favoriteFrag = (FavoritePageFragment) pagesAdapter.getFragment(0);

            favoriteFrag.transferItem(favoriteInfo);
        }
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Create the adapter for the ViewPager, which uses parameters for the layouts of the
        // DynamicGridView and the individual items of these GridViews.
        appPager = (ViewPager) inflater.inflate(R.layout.fragment_app_drawer, container, false);
